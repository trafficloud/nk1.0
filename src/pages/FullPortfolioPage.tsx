...
const FullPortfolioPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-space pt-16">
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-20 pb-16 md:pb-20">
          <div className="text-center mb-12 animate-fade-in">
            <h1 className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Полное портфолио наших работ
            </h1>
            <p className="text-gray-600 max-w-2xl mx-auto text-center">
              Все наши проекты по монтажу электрики в новостройках с примерами "До и После"
            </p>
          </div>
